...
fri_12am_3am.addEventListener("click", (e) => {  //button event, fires the time stamp button is selected
    ...
    if (  alreadylogged === null || logday != "Friday" || logday === null || alreadylogged == false || fl_12am == true){ //checks if the user has already made an appointment, or if the the appointment was made on the current day or if either or null, meaning no appoints have been made
